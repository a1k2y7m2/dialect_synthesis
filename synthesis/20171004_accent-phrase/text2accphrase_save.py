...
if __name__ == '__main__':
    ...
    for text in open(args.targetfile).readlines():
        sentencenum += 1
        ...
        fw = open("/home/akiyama/JNAS/JNAS_scriptdata" + args.targetfile.rstrip("_KAN.txt") + "/" + args.targetfile.rstrip("_KAN.txt") + "{0:03d}".format(sentencenum) + ".txt", "w")
        fw.write("%s\n"%text)
